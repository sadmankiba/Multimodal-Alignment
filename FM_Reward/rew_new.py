...
python examples/scripts/reward_modeling.py \
    ...
    --dataset_name zhiqings/LLaVA-Human-Preference-10K \
...
from transformers import AutoModelForVisualQuestionAnswering, AutoTokenizer, HfArgumentParser
